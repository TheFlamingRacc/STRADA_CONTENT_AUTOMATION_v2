...
- Discord-повідомлення — це **дашборд дня**: прогрес-бар юзер-постів, прогрес-бар engagement, прогрес-бар спільнот. Відправляється незалежно від `USER_POSTS_ENABLED` — якщо пости юзерів вимкнені, секція постів просто відсутня
...
ACTIVE_HOUR_START=8
ACTIVE_HOUR_END=23
USER_POSTS_ENABLED=true            # false = вимкнути пости від юзерів (спільноти, engagement, stories продовжують)

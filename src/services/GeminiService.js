...
ПРО ЩО ПОСТ (КРИТИЧНО):
- Тема поста = тема відео нижче (блок ДЖЕРЕЛО). Пиши САМЕ про неї.
- Опис персонажа вище задає лише голос, стиль і кут зору — НЕ тему.
- Заборонено зміщувати на інші моделі/події/бренди, навіть якщо вони "ближчі" персонажу.
- Якщо у відео конкретна модель чи подія — обговорюєш саме її, через призму персонажа.

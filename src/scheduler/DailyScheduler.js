...
export default class DailyScheduler {
   ...
   */
  generate(users, engagementCount = 0, firstEngagementTime = null, communitySlots = [], listingCount = 0, firstListingTime = null) {
    ...
    DiscordLogger.scheduleGenerated(this.#schedule, engagementCount, firstEngagementTime, communitySlots, listingCount, firstListingTime);
